...
const VehicleDetailsForm = () => {
  ...
  const isPassengerCarrier =
    form.values.vehicleCategory === "Passenger Carrier";
  const hasSubcategory = isGoodsCarrier || isPassengerCarrier;

  const availableMakes = form.values.vehicleCategory
    ? VEHICLE_DATA[form.values.vehicleCategory]?.makes
    : [];
  const availableModels =
    form.values.vehicleCategory && form.values.make
      ...
      <form
        onSubmit={form.onSubmit((values) => {
          ...
          notifications.show({
            ...
            message: "Vehicle details have been submitted.",
            color: "teal",
            ...
            <Grid gutter="md">
              ...
              <Grid.Col span={{ base: 12, md: 4 }}>
                {hasSubcategory && (
                  <Select
                    ...
                    data={
                      VEHICLE_DATA[form.values.vehicleCategory].subcategories
                    }
                    styles={{
                      label: {
                        color: "#495057",
              ...
              <Grid.Col span={{ base: 12, md: 4 }}>
                <Select
                  label="Model"
                  placeholder={
                    form.values.make ? "Select Model" : "Choose Make First"
                  }
              ...
              <Grid.Col span={{ base: 12, md: 4 }}>
                <Group justify="space-between" mb={3}>
                  ...
                  >
                    {form.values.regNoCity
                      ? form.values.regNoCity.split("")[0] +
                        form.values.regNoCity.split("")[1] +
                        form.values.regNoCity.split("")[2] +
                        form.values.regNoCity.split("")[3]
                      : ""}
                    {form.values.regNoCode || ""}
                  </Text>
                </Group>
            ...
            <Grid gutter="xl">
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                <Paper withBorder p="sm" radius="sm">
                  <Text size="sm" fw={500} color="dimmed" mb="sm">
                  ...
                  >
                    <thead>
                      <tr>
                        <th style={{ color: "#868e96", fontWeight: 500 }}>
                          Premium
                        </th>
                        <th style={{ color: "#868e96", fontWeight: 500 }}>
                          Basic
                    ...
                    <tbody>
                      <tr>
                        <td style={{ fontWeight: 600, color: "#495057" }}>
                          OD
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recOdBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recOdBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recOdBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recOdBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recTpBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recTpBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recTpBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recTpBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recNetBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("recNetBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recNetBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("recNetBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            readOnly
                            {...form.getInputProps("recNetTotal")}
                            size="xs"
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("recTotalBasic")}
                              size="xs"
                            />
                          </Stack>
                        </td>
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("recTotalBonus")}
                              size="xs"
                            />
                          </Stack>
                        </td>
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("recFinalReceivable")}
                              size="xs"
                            />
                          </Stack>
                        </td>
              ...
              <Grid.Col span={{ base: 12, md: 6 }}>
                <Paper withBorder p="sm" radius="sm">
                  ...
                  <Radio.Group mb="md" {...form.getInputProps("payableType")}>
                    <Stack mt="xs" gap="xs">
                      <Radio value="Percentage" label="Percentage" size="xs" />
                      <Radio value="Flat" label="Flat" size="xs" />
                    </Stack>
                      ...
                      <tr>
                        ...
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payOdBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payOdBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payOdBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payOdBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payTpBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payTpBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payTpBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payTpBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payNetBasicPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            ...
                            {...form.getInputProps("payNetBonusPercent")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payNetBasicValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            {...form.getInputProps("payNetBonusValue")}
                            size="xs"
                          />
                        </td>
                        <td>
                          <TextInput
                            readOnly
                            {...form.getInputProps("payNetTotal")}
                            size="xs"
                          />
                        </td>
                      </tr>
                      <tr>
                        ...
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("payTotalBasic")}
                              size="xs"
                            />
                          </Stack>
                        </td>
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("payTotalBonus")}
                              size="xs"
                            />
                          </Stack>
                        </td>
                        <td>
                          <Stack gap={0}>
                            ...
                            <TextInput
                              readOnly
                              {...form.getInputProps("payFinalPayable")}
                              size="xs"
                            />
                          </Stack>
                        </td>
